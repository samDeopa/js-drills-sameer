...
console.log(getHobbiesOfAge(arrayOfObjects, 30));
//    Create a function that extracts and displays the names of individuals who are students (`isStudent: true`) and live in Australia.
console.log(getAustralianStudents(arrayOfObjects));
//    Write a function that accesses and logs the name and city of the individual at the index position 3 in the dataset.
let index = 3;
console.log(getCityAndName(arrayOfObjects, index));
//    Implement a loop to access and print the ages of all individuals in the dataset.
printAllAge(arrayOfObjects);
//    Create a function to retrieve and display the first hobby of each individual in the dataset.
console.log(getFirstHobby(arrayOfObjects));
//    Write a function that accesses and prints the names and email addresses of individuals aged 25.
console.log(getEmailOfAge(arrayOfObjects, 25));
//    Implement a loop to access and log the city and country of each individual in the dataset.
logAllCityAndCountries(arrayOfObjects);
